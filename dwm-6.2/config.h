...
static const unsigned int gappx     = 15;        /* size of gaps */
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_Return, spawn,          {.v = termcmd } },
        ...
        { MODKEY,                       XK_k,      spawn,          {.v = pcmanfmcmd} },
        { MODKEY,                       XK_j,      spawn,         SHCMD("cd ~/pictures/ && scrot -s") },
        { MODKEY|ShiftMask,             XK_l,      spawn,          {.v = slockcmd} },
        { MODKEY,                       XK_w,      spawn,         SHCMD("redshift -x") },
        { MODKEY,                       XK_q,      spawn,         SHCMD("redshift -O 2700k") },
